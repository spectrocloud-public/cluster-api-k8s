...
## ⚠️ Regression Watch
6 parity-review candidate(s) — reviewer/human must confirm the target covers the fork's behavior; set risk L/M/H. **High risk blocks auto-progression and requires explicit human sign-off.**
...
## Summary
- PICK=4 (PICK-VERIFY=1 · PICK-RESOLVE=1) · SKIP=2 · REGENERATE=0 · NEEDS-DECISION=18
- INCOMPLETE: unresolved=19 · regen/verify-pending=0 · regression-watch=6 · commit-failures=0
