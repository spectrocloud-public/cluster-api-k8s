...
## ⚠️ Regression Watch
7 parity-review candidate(s) — reviewer/human must confirm the target covers the fork's behavior; set risk L/M/H. **High risk blocks auto-progression and requires explicit human sign-off.**

| sha | decision | files (parity-check) | risk | confirm |
|--|--|--|--|--|
| `29002e71` | PICK-RESOLVE | go.mod   | High | yes |
| `79576dd8` | F4 | spectro/base/bootstrap/delete-namespace.yaml spectro/base/bo | High | yes |
...
| 2 | `79576dd8` | F4 | PCP-4817 Manifest Generation | NEEDS-DECISION | known F4 (diverged) — human review |
...
| 4 | `e71debeb` | F4 | PCP-4817 Additional Fixes | NEEDS-DECISION | conflict on: spectro/base/bootstrap/kustomization.yaml spectro/base/controlplane/kustomization.yaml spectro/generated/bootstrap-base.yaml spectro/generated/bootstrap-global.yaml spectro/generated/controlplane-base.yaml spectro/generated/controlplane-global.yaml spectro/global/bootstrap/kustomization.yaml spectro/global/controlplane/kustomization.yaml  |
| 5 | `0d3289d3` | F4 | PCP-4817 Adding sync period to base manifests | NEEDS-DECISION | conflict on: spectro/base/bootstrap/kustomization.yaml spectro/base/controlplane/kustomization.yaml spectro/generated/bootstrap-base.yaml spectro/generated/controlplane-base.yaml  |
...
| 8 | `90bd017a` | F4 | Adding tolerations to CK8s deployments | NEEDS-DECISION | conflict on: spectro/base/bootstrap/kustomization.yaml spectro/base/controlplane/kustomization.yaml spectro/generated/bootstrap-base.yaml spectro/generated/bootstrap-global.yaml spectro/generated/controlplane-base.yaml spectro/generated/controlplane-global.yaml spectro/global/bootstrap/kustomization.yaml spectro/global/controlplane/kustomization.yaml  |
...
## Summary
- PICK=4 (PICK-VERIFY=1 · PICK-RESOLVE=5) · SKIP=10 · REGENERATE=0 · NEEDS-DECISION=6
- INCOMPLETE: unresolved=11 · regen/verify-pending=0 · regression-watch=7 · commit-failures=0
